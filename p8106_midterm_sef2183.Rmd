...
According to Figure 2, the lasso model had the highest median training RMSE (i.e., worst performance), followed by the GAM using select predictors, the pls model, the linear model, the elastic net model, the GAM using all predictors, and finally, The MARS model, which had the lowest median training RMSE (i.e., best performance).
